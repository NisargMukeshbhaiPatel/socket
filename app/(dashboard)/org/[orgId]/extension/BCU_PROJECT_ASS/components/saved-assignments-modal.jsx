...
export default function SavedAssignmentsModal({ isOpen, onClose, onLoadAssignment }) {
  ...
  useEffect(() => {
    if (isOpen) {
      const assignments = JSON.parse(localStorage.getItem("savedProjectAssignments") || "[]");
  ...
  const handleDeleteAssignment = (index) => {
    ...
    localStorage.setItem("savedProjectAssignments", JSON.stringify(updatedAssignments));
                    ...
                    {editingIndex === index ? (
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="text-sm mt-1">
                          Projects: {assignment.projectAssignments.length}
                        </div>
                      </div>
                    )}
                  </div>
